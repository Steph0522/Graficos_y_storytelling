...
:::: cover
# Los amigos no dejan que los amigos hagan malos gráficos
...
## Friends Don't Let Friends Make Bad Graphs by [cxli233](https://github.com/cxli233/FriendsDontLetFriends)

![](images/repo.png)



## Los amigos no dejan que sus amigos hagan gráficos de barras para separar medias
...
## Barras para separar medias

- Datos a usar 

El grupo 1 viene de un muestreo de una distribución normal con  mean = 1 and sd = 1. 
El grupo 2 viene de un muestreo de una distribución lognormal con mean = 1 and sd = 1. 
...
## Los amigos no dejan que sus amigos usen colores bidireccionales con datos unidireccionales
...
## Los amigos no dejan que sus amigos hagan mapas de calor sin reordenar filas y columnas
...
## Heatmaps reordenado filas y columnas
...
## Heatmap sin reordenar 
::: {.columns}

::: {.column width="40%"}

```{r, echo=TRUE, eval=FALSE, fig.height=18}
...
## Los amigos no dejan que sus amigos hagan gráficos de pastel
...
## Los amigos no dejan que sus amigos olviden reordenar las barras apiladas
...
## Los amigos no dejan que sus amigos usen boxplots para datos bimodales
...
##  Los amigos no dejan que sus amigos olviden checar cada rango para cada grupo de datos
...
## Barras rangos por factor
```{r, echo=TRUE}
head(toydata)
```


## Barplot rango cada factor
::: {.columns}
...
## Los amigos no dejen que sus amigos confundan visualizaciones de posición con longitud
```{r, fig.align='center'}
set.seed(666)
Example_data1 <- rbind(
